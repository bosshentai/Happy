...
Database.then(async db => {
 ...
 /*   await saveOrphanage(db, {
      ...
      about: "Presta assistencia a criança de 06 a 15 anos que se encontre em situaçao de risco e/ou vulnerabilidade social",
      whatsapp: "9999999",
      images: [
    ...
    //consular dados na tabela
  /* const selectedOrphanages = await db.all("SELECT * FROM orphanages")
    console.log(selectedOrphanages)*/



    // consultar somente 1 orphanato, pelo id need
